...
<head>
    ...
    <meta http-equiv="refresh" content="0; url=https://personal-market.ru/general-blog.php">
    ...
    <div class="wrapper">
        ...
        <main>
            ...
            <section class="news-home">
                ...
                <div class="container news-home__container">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <p class="breadcrumb-text text-grey">Статьи и новости </p>
                        </li>
                    </ul>
                    <h1 class="text-h1">Статьи и новости </h1>
                    <ul class="news-home__tegs-wrap">
                        <li class="news-home__tegs">
                            <input type="checkbox" name="" id="" checked>
                            <div class="news-home__tegs-text">#аутсорсинг</div>
                        </li>
                        <li class="news-home__tegs">
                            <input type="checkbox" name="" id="">
                            <div class="news-home__tegs-text">#аустаффинг</div>
                        </li>
                        <li class="news-home__tegs">
                            <input type="checkbox" name="" id="">
                            <div class="news-home__tegs-text">#новости_рынка</div>
                        </li>
                        <li class="news-home__tegs">
                            <input type="checkbox" name="" id="">
                            <div class="news-home__tegs-text">#комплектовщики</div>
                        </li>
                        <li class="news-home__tegs">
                            <input type="checkbox" name="" id="">
                            <div class="news-home__tegs-text">#кладовщики</div>
                        </li>
                        <li class="news-home__tegs">
                            <input type="checkbox" name="" id="">
                            <div class="news-home__tegs-text">#упаковщики</div>
                        </li>
                        <li class="news-home__tegs">
                            <input type="checkbox" name="" id="">
                            <div class="news-home__tegs-text">#грузчики</div>
                        </li>
                        <li class="news-home__tegs">
                            <input type="checkbox" name="" id="">
                            <div class="news-home__tegs-text">#водители погрузчиков</div>
                        </li>
                        <li class="news-home__tegs">
                            <input type="checkbox" name="" id="">
                            <div class="news-home__tegs-text">#комплектовщики</div>
                        ...
                        <li class="news-home__tegs">
                            <input type="checkbox" name="" id="">
                            <div class="news-home__tegs-text">показать еще</div>
                        </li>
                        <li class="news-home__tegs">
                            <input type="checkbox" name="" id="">
                            <div class="news-home__tegs-text">#упаковщики</div>
            ...
            <section class="article">
                <div class="container">
                    <div class="article-content column-reverse">
                        <div class="article-content__left">
                            ...
                            <div>
                                <h3 class="article-title">Рубрика какая-то</h3>
                                <ul class="article-list">
                                    <li class="article-list__item">
                                        <div class="article-list__date">21.04.2025</div>
                                        <div class="article-list__text">Автоматизация найма складского персонала</div>
