...
<head>
    ...
    <meta http-equiv="refresh" content="0; url=https://personal-market.ru/vacancy-card.php">
...
<body>
    ...
    <div class="wrapper">
        ...
        <main>
            ...
            <!-- Service home -->
            <section class="vacancy-home">
                <div class="container vacancy-home__container">
                    <ul class="breadcrumb">
                        <li>
                    ...
                    <h1 class="text-h1">
                        Вакансии <span>грузчиков</span> в Москве 
                        круглосуточно на 1 час
                    </h1>
                    <div class="vacancy-home__card-wrap">
                        <img src="./assets/images/vacancy-home-card.png" alt="" class="main-img">
                        <div class="vacancy-home__card">
                            <h3 class="card-price">от 500 руб/час</h3>
                            <ul class="card-list">
                                <li class="card-list__item">
                                    <div class="icon">
                                        <img src="./assets/images/location.svg" alt="">
                                    </div>
                                    <span>Место: офис </span>
                                </li>
                                <li class="card-list__item">
                                    <div class="icon">
                            ...
                            <div class="form-group">
                                <label class="form-label">Ваше e-mail:</label>
                                <input type="email" placeholder="Введите вашу почту" class="form-inp">
                            </div>
                            <a href="#" class="btn-yellow">
                                <span class="btn-text">Получить работу</span>
            ...
            <section class="job">
                <div class="container">
                    <div class="text-subtitle">[ описание вакансии ]</div>
                    <div class="job-content">
                        <div class="job-left">
                            <div>
                                <h3 class="text-title">Должностные обязанности:</h3>
                                <ul class="text-list">
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Погрузка, разгрузка и перемещение товаров, грузов и оборудования</span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Укладка и складирование продукции с соблюдением правил хранения</span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Проверка целостности груза при погрузке и разгрузке</span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Соблюдение порядка и чистоты на рабочем месте</span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Участие в инвентаризации товара (при необходимости)</span>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <h3 class="text-title">Требования:</h3>
                                <ul class="text-list">
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Физическая выносливость и готовность к активной работе</span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Ответственность, внимательность и аккуратность</span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Опыт работы грузчиком приветствуется, но не обязателен (проводим обучение)</span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Желание работать в команде и выполнять задачи качественно</span>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <h3 class="text-title">Условия:</h3>
                                <ul class="text-list__wrap">
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Гибкий график работы: дневные, вечерние или ночные смены </span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>(выбирайте удобный для вас вариант)</span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Стабильная оплата труда: выплаты производятся еженедельно</span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Выдаем спецодежду и обеспечиваем безопасные условия труда</span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Возможность подработки или постоянной занятости</span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Работа в дружном коллективе, поддержка опытных бригадиров</span>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <h3 class="text-title">Что мы предлагаем:</h3>
                                <ul class="text-list">
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Достойную оплату за каждый час работы</span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Возможность быстрого трудоустройства и выхода на работу</span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Перспективы карьерного роста (до бригадира)</span>
                                    </li>
                                    <li class="text-list__item">
                                        <img src="./assets/images/check-circle-icon.svg" alt="" class="icon">
                                        <span>Возможность подработки или постоянной занятости</span>
                        ...
                        <div class="job-right">
                            ...
                            <div class="form-group">
                                <label class="form-label">Кол-во дней в месяц в день:</label>
                                <ul class="form-radio__wrap">
                                    <li class="form-radio">
                            ...
                            <div>
                                <div class="form-label">Дополнительные услуги:</div>
                                <ul class="form-checkbox__wrap">
                                    <li class="form-checkbox">
                                        ...
                                        <div class="form-checkbox__text">Пронос по этажам (от 30 рублей за этаж)</div>
                                    </li>
                                    <li class="form-checkbox">
                                        ...
                                        <div class="form-checkbox__text">Подъем-спуск на лифте как два этажа</div>
                                    </li>
                                    <li class="form-checkbox">
                                        <input type="checkbox" name="" id="">
                                        <div class="form-checkbox__icon">
                            ...
                            <div class="job-right__price">Итого: 12 000 руб/месяц</div>
                            <div class="line"></div>
                            <div class="description">Если вы хотите стабильный доход, цените четкую организацию работы и готовы трудиться в команде — ждём именно вас!  </div>
                            <div class="form-group">
                            ...
                            <div class="form-control">
                                ...
                                <div class="form-group">
                                    <div class="form-label">Ваше e-mail:</div>
                                    <input type="email" placeholder="Введите вашу почту" class="form-inp">
                                </div>
                            </div>
                            <button class="btn-yellow">
                                <span class="btn-text">Откликнуться на вакансию</span>
                                <img src="./assets/images/play-icon.svg" alt="" class="btn-icon">
                            </button>
                        </div>
                    </div>
                    <ul class="job-foot">
                        <li class="job-foot__item">
                            ...
                            <div class="job-foot__text">Лучшие условия <br> на рынке</div>
                        </li>
                        <li class="job-foot__item">
                            <img src="./assets/images/job-foot-icon-2.svg" alt="">
                            <div class="job-foot__text">Самая легкая <br> работа</div>
                        </li>
                        <li class="job-foot__item">
                            <img src="./assets/images/job-foot-icon-3.svg" alt="">
                            <div class="job-foot__text">Гарантия оплаты <br>100%</div>
                        </li>
                    </ul>
                </div>
            </section>
