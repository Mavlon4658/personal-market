...
<head>
    ...
    <meta http-equiv="refresh" content="0; url=https://personal-market.ru">
        ...
        <header class="header">
            <div class="container header-container">
                ...
                <div class="header-location">
                    <button class="header-location__btn">
                        <img src="./assets/images/location-icon.svg" alt="">
                        <span>Москва</span>
                        <input type="text" value="Москва" readonly hidden>
                    </button>
                ...
                <div class="header-network">
                    ...
                    <a href="#" class="btn-dark service-modal__open">Обратный звонок</a>
                </div>
        ...
        <main>
            ...
            <section class="home">
                ...
                <div class="container home-container">
                    <h1 class="text-h1 home-title">
                        <span>Сервис №1</span> по подбору рабочего персонала
                    </h1>
                    <div class="home-rating">
                        <div class="home-rating__stars">
                        ...
                        <div class="home-rating__text-wrap">
                            <div class="imgs">
                                <img src="./assets/images/expert-1.png" alt="">
                                <img src="./assets/images/expert-2.png" alt="">
                                <img src="./assets/images/expert-3.png" alt="">
                            </div>
                            <p class="home-rating__text">Более 16 000 <br> специалистов в базе</p>
                        </div>
                    </div>
                    <div class="home-form">
                        <div class="home-form__text">Подбор персонала от 100р/час:</div>
                        <div class="home-form__group">
                            <label for="" class="home-form__label">Ваш телефон:</label>
                            <input type="tel" placeholder="+7 (999) 999-99-99" class="home-form__inp">
                            <button class="home-form__btn btn-yellow">
                                <span class="btn-text">Подобрать персонал</span>
                                <img src="./assets/images/play-icon.svg" alt="" class="btn-icon">
                            </button>
                        </div>
                    </div>
                    <ul class="home-texts">
                        <li class="home-texts__item">
                            <img src="./assets/images/home-icon-1.svg" alt="" class="home-texts__item-icon">
                            <p class="home-texts__item-text"><span>Актуальные</span> <br> цены на аутсорсинг <br> и грузчиков </p>
                        </li>
                        <li class="home-texts__item">
                            <img src="./assets/images/home-icon-2.svg" alt="" class="home-texts__item-icon">
                            <p class="home-texts__item-text">Предоставляем <br> <span>гарантии</span> <br> на выход рабочих </p>
                        </li>
                        <li class="home-texts__item">
                            <img src="./assets/images/home-icon-3.svg" alt="" class="home-texts__item-icon">
                            <p class="home-texts__item-text">Работаем <br> <span>24 часа</span> в неделю <br> 365 дней в году</p>
                        </li>
                    </ul>
                    <img src="./assets/images/home-card.png" alt="" class="home-card">
                    <div class="home-alert">
                        <img src="./assets/images/alert-icon.svg" alt="" class="icon">
                        Кадры решают все
                    </div>
                </div>
            </section>
            ...
            <section class="services">
                <div class="container">
                    <h3 class="text-subtitle">[ услуги ]</h3>
                    <h2 class="text-h2">Предоставляем исполнителей по всей России</h2>
                    <div class="services-content">
                        <div class="services-content__left">
                            ...
                            <div class="services-content__left-body">
                                ...
                                <a href="#" class="btn-yellow-outline">Сбросить фильтры</a>
                            </div>
                        </div>
                        <div class="services-content__right">
                            <div>
                                <div class="form-group">
                                    <div class="form-group__left">
                                        <label for="" class="form-group__label">Какие работники вам нужны</label>
                                        <div class="form-control">
                                            <select name="" id="">
                                    ...
                                    <div class="form-group__right">
                                        <label for="" class="form-group__label">На какую дату</label>
                                        <div class="form-control">
                                            <input type="text" class="form-inp form-date" placeholder="__/__/____">
                                            <button class="btn-yellow">
                                                <img src="./assets/images/btn-icon-3.svg" alt="">
                                ...
                                <ul class="tegs-wrap">
                                    <li>
                                        <a href="#" class="tegs">#упаковщики</a>
                                    </li>
                                    <li>
                                        <a href="#" class="tegs">#грузчики</a>
                                    </li>
                                    <li>
                                        <a href="#" class="tegs">#водители погрузчиков</a>
                                    </li>
                                    <li>
                                        <a href="#" class="tegs">#комплектовщики</a>
                                    </li>
                                    <li>
                                        <a href="#" class="tegs">#кладовщики</a>
                                    </li>
                                    <li>
                                        <a href="#" class="tegs">показать еще</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="product">
                                ...
                                <div class="product-card__wrap">
                                    <div class="product-form">
                                        <h3 class="product-form__title">Подбор персонала от&nbsp;100₽/час </h3>
                                        <p class="product-form__text">Оставьте контакты и мы организуем подбор персонала </p>
                                        <div>
                                            <label for="" class="product-form__label">Ваше имя:</label>
                                            <input type="text" placeholder="имя" class="product-form__inp">
                                        </div>
                                        <div>
                                            <label for="" class="product-form__label">Ваш телефон:</label>
                                            <input type="tel" placeholder="+7" class="product-form__inp">
                                        </div>
                                        <button class="btn-black">
                                            <span class="btn-text">Подобрать быстро</span>
                                            <img src="./assets/images/play-icon-white.svg" alt="" class="btn-icon">
                                        </button>
                                        <ul class="product-form__tegs-wrap">
                                            <li>
                                                <a href="#" class="product-form__tegs">#удаленно</a>
                                            </li>
                                            <li>
                                                <a href="#" class="product-form__tegs">#летом</a>
                                            </li>
                                            <li>
                                                <a href="#" class="product-form__tegs">#каникулы</a>
                                            </li>
                                            <li>
                                                <a href="#" class="product-form__tegs">#на складе</a>
                                            </li>
                                            <li>
                                                <a href="#" class="product-form__tegs">#подработка</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="product-card">
                                        <div class="product-card__head">
                                            ...
                                            <h3 class="product-card__title">Фасовщик в Москве на&nbsp;предприятие склад</h3>
                                            <ul class="product-card__text-wrap">
                                                <li class="product-card__text">
                                                    <img src="./assets/images/product-icon-1.svg" alt="">
                                                    <span>Продложительность: 1 час</span>
                                                </li>
                                                <li class="product-card__text">
                                                    <img src="./assets/images/product-icon-2.svg" alt="">
                                                    <span>Гендер: Мужчина</span>
                                                </li>
                                            </ul>
                                            <div class="product-card__price">от 100₽/час</div>
                                        </div>
                                        <div class="product-card__foot">
                                            <ul class="product-card__tegs-wrap">
                                                <li>
                                                    <a href="#" class="product-card__tegs">#склад</a>
                                                </li>
                                                <li>
                                                    <a href="#" class="product-card__tegs">#завод</a>
                                                </li>
                                                <li>
                                                    <a href="#" class="product-card__tegs">#завод</a>
                                                </li>
                                                <li>
                                                    <a href="#" class="product-card__tegs">#предприятие</a>
                                                </li>
                                                <li>
                                                    <a href="#" class="product-card__tegs">#предприятие</a>
                                                </li>
                                    ...
                                    <div class="product-card">
                                        ...
                                        <h3 class="product-card__title">Фасовщик sdfasdfas dfasdf в Москве на&nbsp;предприятие склад</h3>
                                        <ul class="product-card__text-wrap">
                                            <li class="product-card__text">
                                                <img src="./assets/images/product-icon-1.svg" alt="">
                                                <span>Продложительность: 1 час</span>
                            ...
                            <!-- Product -->
                            <div class="product">
                                <div class="product-title">Аутсорсинг персонала</div>
                                <div class="product-card__wrap">
                                    <div class="product-card">
                                        <div class="main-img">
                                            <img src="./assets/images/product-card-1.png" alt="">
                            ...
                            <!-- Product -->
                            <div class="product">
                                <div class="product-title">Аутстафинг персонала</div>
                                <div class="product-card__wrap">
                                    <div class="product-card">
                                        <div class="main-img">
                                            <img src="./assets/images/product-card-1.png" alt="">
            ...
            <section class="partner">
                <div class="container">
                    <div class="text-subtitle">[ нам доверяют ]</div>
                    <h2 class="text-h2">Наши парнеры</h2>
                    <div class="partner-swp">
                        <div class="swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide partner-card">
                                    <img src="./assets/images/partner-icon-1.svg" alt="" class="logo">
                                    <div class="partner-card__text">Крупнейший поисковик авиабилетов в России</div>
                                </div>
                                <div class="swiper-slide partner-card">
                                    <img src="./assets/images/partner-icon-2.svg" alt="" class="logo">
                                    <div class="partner-card__text">Крупнейший поисковик авиабилетов в России</div>
                                </div>
                                <div class="swiper-slide partner-card">
                                    <img src="./assets/images/partner-icon-1.svg" alt="" class="logo">
                        ...
                        <div class="partner-swp__control">
                            <button class="swp-btn swp-btn__prev">
                                <img src="./assets/images/swp-prev.svg" alt="">
                            </button>
                            <div class="swp-fraction">
