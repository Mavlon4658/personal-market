...
<head>
    ...
    <meta http-equiv="refresh" content="0; url=https://personal-market.ru/vacancy.php">
...
<body>
    ...
    <div class="wrapper">
        ...
        <main>
            ...
            <!-- Service home -->
            <section class="service-home vacancy">
                <div class="container service-home__container">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <p class="breadcrumb-text text-grey">Вакансии грузчиков в Москве</p>
                        </li>
                    </ul>
                    <div class="service-home__head">
                        <h1 class="text-h1">
                            Вакансии <span>грузчиков</span> <br>
                            в Москве
                        </h1>
                        <div class="service-home__head-card">
                            <p class="service-home__head-card__text">Ежеденевно обеспечиваем хорошооплачиваемой работой  более 5 000 исполнителей</p>
                            <a href="#" class="btn-yellow">
                    ...
                    <img src="./assets/images/vacancy-card-1.png" alt="" class="service-home__card">
                </div>
            </section>
            <!-- Service home end -->
