...
<head>
    ...
    <meta http-equiv="refresh" content="0; url=https://personal-market.ru/service.php">
    ...
    <div class="wrapper">
        ...
        <main>
            ...
            <section class="service-home">
                <div class="container service-home__container">
                    <ul class="breadcrumb">
                        <li>
                        ...
                        <li>
                            <a href="#" class="breadcrumb-text">Аутсорсинг</a>
                        </li>
                        <li>
                            <img src="./assets/images/breadcrumb-icon.svg" alt="">
                        </li>
                        <li>
                            <a href="#" class="breadcrumb-text">Аутсорсинг персонала на склад</a>
                        </li>
                        <li>
                            <img src="./assets/images/breadcrumb-icon.svg" alt="">
                        </li>
                        <li>
                            <p class="breadcrumb-text text-grey">Аутсорсинг персонала на склад в Москве</p>
                        </li>
                    </ul>
                    <div class="service-home__head">
                        <h1 class="text-h1">
                            <span>Аутсорсинг</span> персонала <br>
                            на склад в Москве
                        </h1>
                        <div class="service-home__head-card">
                            <p class="service-home__head-card__text">Предоставляем временных исполнителей под любые задачи вашего бизнеса точно в срок</p>
                            <a href="#" class="btn-yellow">
                                <span class="btn-text">Обсудить задачу</span>
                                <img src="./assets/images/play-icon.svg" alt="" class="btn-icon">
                            </a>
                        </div>
                    </div>
                    <img src="./assets/images/service-home-card.png" alt="" class="service-home__card">
                    <div class="service-home__head-card sm">
                        <p class="service-home__head-card__text">Предоставляем временных исполнителей под любые задачи вашего бизнеса точно в срок</p>
                        <a href="#" class="btn-yellow">
                            <span class="btn-text">Обсудить задачу</span>
                            <img src="./assets/images/play-icon.svg" alt="" class="btn-icon">
                            ...
                            <div>
                                <div class="form-group">
                                    ...
                                    <div class="form-group__right">
                                        ...
                                        <div class="form-control">
                                            <input type="text" class="form-inp date" placeholder="__/__/____">
                                            <button class="btn-yellow">
                                                <img src="./assets/images/btn-icon-3.svg" alt="">
                                            </button>
                                        </div>
